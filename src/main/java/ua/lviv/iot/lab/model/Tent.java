...
public class Tent extends Good {
    ...
    public Tent(final String name, final int quantity, final String manufacturer, final float price,
                final float weight, final boolean isForHikingCamping, final float area, final float height,
